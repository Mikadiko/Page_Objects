...
public class MoneyTransferTest {
    ...
    void shouldTransferFromFirstToSecond() {
        ...
        assertAll(() -> assertEquals(expectedBalanceFirstCard, actualBalanceFirstCard), //assertAll позволяет проверить
                () -> assertEquals(expectedBalanceSecondCard, actualBalanceSecondCard));//выполнение двух условий
    }
    ...
    void shouldGetErrorMessageIfAmountMoreBalance() {
        ...
        assertAll(() -> assertEquals(firstCardBalance, actualBalanceFirstCard), //assertAll позволяет проверить
                () -> assertEquals(secondCardBalance, actualBalanceSecondCard));//выполнение двух условий
    }
}